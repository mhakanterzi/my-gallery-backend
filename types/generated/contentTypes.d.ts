...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    book_status: Schema.Attribute.String &
...
export interface ApiCarRequestCarRequest extends Struct.CollectionTypeSchema {
...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    car_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::car-request.car-request'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiServiceRequestServiceRequest
  ...
  attributes: {
    AboutCar: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::car-request.car-request': ApiCarRequestCarRequest;
